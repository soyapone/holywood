...
exports.logicalValidation = function(Fd,b,l,bprima,lprima,a1,a2,l1,h,Continuous,s,service,LoadDuration,gammaM) {
...
exports.funcion = function(Fd,b,l,bprima,lprima,a1,a2,l1,h,Continuous,s,service,LoadDuration,gammaM){
  var CompresionPerpendicular = tabla.getfc90k(s);
  var kmod = tabla.findServiceDuracion(service,LoadDuration);
  return this.compresion90Kmod(Fd,b,l,bprima,lprima,a1,a2,l1,h,Continuous,s,kmod,CompresionPerpendicular,gammaM);
}

exports.compresion90Kmod = function(Fd,b,l,bprima,lprima,a1,a2,l1,h,durmiente,tipoMadera,kmod,CompresionPerpendicular,gammaM){
  ...
  var areaEf = areaEf - (bprima*lprima);
