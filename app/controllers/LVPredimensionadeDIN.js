...
StaticFunction = require('../statics/LVPredimensionadeDIN'),
...
module.exports = function (app,mypassport) {
  app.use('/LVPredimensionadeDIN', router);
  passport = mypassport;
};
...
//http://localhost:3705/LVPredimensionadeDIN/?tv=30
router.get('/', function (req, res) {
  ...
  visitor.pageview("/LVPredimensionadeDIN").send();

  db.SaveAPIRequest(req.connection.remoteAddress,"LVPredimensionadeDIN",inputs);
});


// //Para cálculos del estilo http://localhost:3705/LVPredimensionadeDIN/GUI/
...
// });
//
// //Para cálculos del estilo http://localhost:3705/LVPredimensionadeDIN/doc/
